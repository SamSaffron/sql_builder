...
$raw_connection.exec "DROP TABLE cars" rescue nil
$raw_connection.exec "CREATE TABLE cars(id serial primary key, make varchar, color varchar, max_speed int)"
$raw_connection.exec "CREATE INDEX idx_color ON cars (color, max_speed)"
